...
TEXT_1 = (
    ...
    "TEAM — это сообщество людей, которые хотят создавать, а не просто учиться и также мы помогаем нашим студентам развивать карьеру и находить стажировки. (ссылка не нужна в этом разделе)"
)
...
TEXT_3 = (
    ...
    "мероприятия, встречи с предпринимателями.После завершения курса можно поступить без вступительных экзаменов. (ссылка не нужна в этом разделе) "
)
...
TEXT_10 = (
    ...
    "(ссылка не нужна в этом разделе)"
)
