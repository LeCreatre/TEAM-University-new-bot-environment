...
# === Главное меню (строго в заданном порядке) ===
MENU = [
    "О TEAM University",
    "Программы Обучения",
    "Курс Pre-Foundation",
...
# === ТЕКСТЫ СООБЩЕНИЙ (с нужными ссылками и без служебных пометок) ===
TEXT_START = (
...
# Раздел 2: кликабельная фраза «Узнать подробнее о направлении» без лишних кнопок и без дублей URL
TEXT_2 = (
    "В TEAM University есть 3 актуальные программы обучения: \n"
    "BA (Hons) Предпринимательство и Международный Бизнес \n"
    "<a href='https://teamuni.uz/ru/ba-hons-entrepreneurship-with-international-business/'>Узнать подробнее о направлении</a>\n\n"
    "BA (Hons) Предпринимательство и Цифровые Инновации\n"
    "<a href='https://teamuni.uz/ru/ba-hons-entrepreneurship-with-digital-innovations/'>Узнать подробнее о направлении</a>\n\n"
    "BA (Hons) Предпринимательство и Маркетинг\n"
    "<a href='https://teamuni.uz/ru/ba-hons-entrepreneurship-with-marketing/'>Узнать подробнее о направлении</a>"
)
...
TEXT_7 = (
    "Открой двери TEAM University в 3D-туре!\n"
...
TEXT_9 = (
    "Если у вас остались вопросы — о поступлении, грантах, оплате или просто о студенческой жизни — пишите нам прямо сейчас.\n"
...
# === Инлайн-кнопки "ниже" именно там, где они должны быть ===
...
SECTIONS = {
    ...
    "Программы Обучения": (TEXT_2, None),  # без кнопок, только кликабельные фразы
...
async def handle_menu(message: types.Message):
    ...
    if btn is None:
        ...
        kb.add(InlineKeyboardButton(text=btn[0], url=btn[1]))
...
if __name__ == "__main__":
    assert TOKEN and ":" in TOKEN, "BOT_TOKEN пустой или задан некорректно"
